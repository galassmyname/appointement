...
<body>
    <div class="container">
        ...
        <div class="content">
            <div class="icon">📅</div>
            <p>Bonjour <strong>{{ $rendezvous->client->name }}</strong>,</p>
            ...
            <div class="details">
                <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
                    ...
                    <tr>
                        <td style="border: 1px solid #ddd; padding: 8px;"><strong>Prestataire</strong></td>
                        <td style="border: 1px solid #ddd; padding: 8px;">{{ $rendezvous->prestataire->name }}</td>
                    </tr>
                    <tr>
                        <td style="border: 1px solid #ddd; padding: 8px;"><strong>Email du prestataire</strong></td>
                        <td style="border: 1px solid #ddd; padding: 8px;">{{ $rendezvous->prestataire->email }}</td>
                    </tr>
                    <tr>
                        <td style="border: 1px solid #ddd; padding: 8px;"><strong>Téléphone du prestataire</strong></td>
                        <td style="border: 1px solid #ddd; padding: 8px;">{{ $rendezvous->prestataire->telephone }}</td>
                    </tr>
                    <tr>
